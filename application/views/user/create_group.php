  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <!-- left column -->
          <form class="form" method="post" action="<?= base_url() ?>admin/post_new_group" enctype="multipart/form-data">
                ...
                <h3 class="card-title">Group info</h3>
		           ...
		           <div class="row">
			          ...
			          <div class="col-md-8">
						...
						<center>
							 <img src="<?= base_url() ?>assets/img/img-holder.png" id="thumbnail-preview" class="img-responsive" style="width: 50%">
						</center>
						 <div class="custom-file">
		                  <input type="file" name="imgChooser" class="custom-file-input" id="imgChooser" required>
